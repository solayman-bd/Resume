...
const projectsData = [
  {
    ...
    featureDetails: `Noticeable features:

    1. In Homepage Items are represented in cards designed by bootstrap
    2. Products informations are loaded from database.
    ...
    7. By clicking the admin option of the navbar admin can add products with details that will saved in database and will be shown in the homepage dynamically. Admin can delete the products from database also by simply clicking the delete button in manage product option.
    8. In homepage spinner is added when the data are loaded from the database.
    9. Used technology : html, css, javascript, react , node, mongodb, heroku etc.`,
  ...
  },
  {
    ...
    img: rImg,
    feature:
      "This is a ride sharing website from where the passengers can choose their favourite ride to go to their destination .",
    featureDetails: `Noticeable Features:

    1. This is a riding solution based website where the customer can choose his/her riding option.
    2. In the homepage some travel options are shown that are designed by bootstrap where the data are loaded from fake data that are generated.
    3. React Router , private route are used
    4. This is a website focused in firebase authentication where in login system "email password" and "google sign in" methods are used.
  ...
  },
  {
    ...
    featureDetails: `This site is all about the football clubs and their details where the user by a simple click will be able to explore the information about the famous clubs..
